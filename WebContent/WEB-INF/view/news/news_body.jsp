...
<script src="resource/js/donut-script.js">
											...
											<div class="row">
												...
												<div class="col">
													<div class="auth-title">
														...
														<div class="bio">Developer at GBJ solution. I love
															to travel, make new friends. I prefer tea over coffee.</div>
			...
			<div class="col-md-3">
				<div class="row mb-2">
					<div class="col-md-12">
						...
						<h3>All keyword</h3>
						<div id="donut-chart" class="height-360"></div>
